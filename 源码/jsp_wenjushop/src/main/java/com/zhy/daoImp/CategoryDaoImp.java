...
public class CategoryDaoImp implements CategoryDao {
	...
	@Override
	public List<Wenju> getWenjusByCategoryId(int categoryId) {
		Wenju wenju = null;
		List<Wenju> wenjus = new ArrayList<Wenju>();
		String categoryName = getCategoryById(categoryId).getName();
		String sql = "SELECT * from wenju where category='" + categoryName + "'";
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		try {
	...
	@Override
	public int getWenjusSizeByCategoryId(int categoryId) {
 		String categoryName = getCategoryById(categoryId).getName();
		String sql = "SELECT count(*) from wenju where category='" + categoryName + "'";
		Connection connection = null;
		int result = 0;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
