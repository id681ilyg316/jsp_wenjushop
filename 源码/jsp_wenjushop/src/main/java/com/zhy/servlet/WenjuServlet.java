...
/**
 * Servlet implementation class WenjuServlet
 */
@WebServlet("/WenjuServlet")
public class WenjuServlet extends BaseServlet {
	...
	public void delete(HttpServletRequest request, HttpServletResponse response) {
		...
		DaoFactory.getWenjuDao().deleteWenju(Integer.parseInt(id));
		try {
	...
	public void add(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Wenju wenju = new Wenju(list.get(0), list.get(2), Integer.parseInt(list.get(1)), list.get(4),Integer.parseInt(list.get(3)) , list.get(5),
				cover);
		DaoFactory.getWenjuDao().addWenju(wenju);
	...
	public void update(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String finalPhotoName = "/img/product/" + filename;
		String cover = finalPhotoName;
		Wenju wenju = new Wenju(Integer.parseInt(list.get(6)), list.get(0), list.get(2), Integer.parseInt(list.get(1)), list.get(4),Integer.parseInt(list.get(3)) , list.get(5),
				cover);
		DaoFactory.getWenjuDao().updateWenju(wenju);
