					...
					<div class="tab-content">
						<div class="tab-pane active" id="th">
							<div class="row">
								...
								<c:forEach var="wenju" items="${category }">
									<div class="col-lg-2 col-md-4 col-sm-6">
										<!-- single-product-start -->
										<div class="product-wrapper mb-40">
											<div class="product-img">
												<a> <img
													src="${pageContext.request.contextPath }${wenju.cover}"
													alt="wenju" class="primary" width="200" height="200" />
												</a>
											...
											<div class="product-details text-center">
												...
												<h4>
													<a><span>${wenju.name }</span></a>
												</h4>
												<div class="product-price">
													<ul>
														<li>$${wenju.price }.00</li>
													</ul>
												</div>
											</div>
											<div class="product-link">
												<div class="product-button">
													<a
														href="${pageContext.request.contextPath }/CartServlet?method=add&id=${wenju.id}"><i
							...
							<ul class="pagination">
								<li><a
									href="/wenjushop/CategoryServlet?method=getAllwenjus&page=${nowpage - 1}">«</a></li>
								<c:forEach var="i" begin="1" end="${ pagesize }">
									<c:if test="${nowpage eq i}">
										<li><a class="active"
											href="/wenjushop/CategoryServlet?method=getAllwenjus&page=${nowpage}">${i}</a></li>
									</c:if>
									<c:if test="${nowpage ne i}">
										<li><a
											href="/wenjushop/CategoryServlet?method=getAllwenjus&page=${i}">${i}</a></li>
									</c:if>
								</c:forEach>
								<li><a
									href="/wenjushop/CategoryServlet?method=getAllwenjus&page=${nowpage + 1}">«</a></li>
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a> <img src="img/product/3.jpg" alt="wenju"
													class="primary" />
												</a>
											</div>
										</div>
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a> <img src="img/product/18.jpg" alt="wenju"
													class="primary" />
												</a>
											</div>
										</div>
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a> <img src="img/product/10.jpg" alt="wenju"
													class="primary" />
												</a>
											</div>
										</div>
							...
							<div class="single-shop mb-30">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a> <img src="img/product/5.jpg" alt="wenju"
													class="primary" />
												</a>
											</div>
										</div>
							...
							<div class="single-shop">
								<div class="row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="product-wrapper-2">
											<div class="product-img">
												<a> <img src="img/product/19.jpg" alt="wenju"
													class="primary" />
												</a>
											</div>
										</div>
