				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="th">
										...
										<div class="product-wrapper mb-40">
											<div class="product-img">
												<a> <img
													...
													alt="wenju" class="primary" width="150" height="150" />
												</a>
							...
							<ul class="pagination">
								<li><a
									href="/wenjushop/CategoryServlet?method=get&id=${cateid}&page=${nowpage - 1}">«</a></li>
								<c:forEach var="i" begin="1" end="${ pagesize }">
									<c:if test="${nowpage eq i}">
										<li><a class="active"
											href="/wenjushop/CategoryServlet?method=get&id=${cateid}&page=${nowpage}">${i}</a></li>
									</c:if>
									<c:if test="${nowpage ne i}">
										<li><a
											href="/wenjushop/CategoryServlet?method=get&id=${cateid}&page=${i}">${i}</a></li>
									</c:if>
								</c:forEach>
								<li><a
									href="/wenjushop/CategoryServlet?method=get&id=${cateid}&page=${nowpage + 1}">«</a></li>
