...
<title>后台管理 - 精品文具</title>

<!-- 公共样式 开始 -->
<link rel="shortcut icon" href="img/logo.jpg" />
<link rel="wenjumark" href="img/logo.jpg" />
	...
	<div class="frameMenu">
		...
		<div class="menu">
			<ul>
				...
				<li><a class="menuFA" href="javascript:void(0)"><i class="iconfont icon-shangpin left"></i>文具管理<i
						class="iconfont icon-dajiantouyou right"></i></a>
					<dl>

						<dt>
							<a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_list.jsp?page=1&size=9',this)">基本文具库</a>
						</dt>
						<dt>
							<a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_add.jsp',this)">添加文具</a>
						</dt>
					</dl></li>
