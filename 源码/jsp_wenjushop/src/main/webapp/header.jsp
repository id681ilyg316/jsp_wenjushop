									...
									<div class="cart-product">
										<c:forEach items="${sessionScope.shoppingCart.cartItems }" var="cartItem">
											<div class="single-cart">
												<div class="cart-img">
													<a><img src="${pageContext.request.contextPath }${cartItem.wenju.cover}"
														style="width: 100px; height: 100px"></a>
												</div>
												<div class="cart-info">
													<h5>
														<a>${cartItem.wenju.name }</a>
													</h5>
													<br> <br>
													<p>数量：${cartItem.quantity } &nbsp单价：${cartItem.wenju.price }</p>
												</div>
												<div class="cart-icon">
													<a
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="menu-area">
					<nav>
						<ul>
							<li class="active"><a href="${pageContext.request.contextPath }/CategoryServlet?method=getAllwenjus">全部文具<i
